...
export default ({ navigation, review }) => (
    ...
    >
        <Text
            style={{ ...styles.productTitle, marginVertical: 0, color: "#515C6F", marginHorizontal:20 }}
            numberOfLines={1}
        >
            {review.ProductName}
        </Text>
        <View style={{ display: "flex", flexDirection: "row", marginLeft: 10, marginRight: 10, paddingVertical: 5 }}>
            <Image
                source={{ uri: review.MainImage }}
        ...
        <View style={[styles.HorizontalLine,{marginBottom:10}]}></View>
